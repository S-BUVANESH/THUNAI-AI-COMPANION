...
function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-[80vh] md:min-h-[92vh] flex items-center bg-[#16351a]"
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        >
          ...
          <source
            src="https://videos.pexels.com/video-files/857195/857195-uhd_2560_1440_30fps.mp4"
            type="video/mp4"
          />
        </video>
      ...
      <div className="container relative text-white py-24">
        ...
        <p className="mt-4 max-w-2xl text-white/90 text-lg md:text-xl">
          THUNAI is an enterprise-grade AI platform that equips farmers in Tamil
          Nadu with the real-time intelligence needed to mitigate risks,
          increase yield, and ensure sustainability.
        </p>
    ...
    <section id="features" className="bg-secondary py-20">
      <div className="container">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">
          An Integrated Platform for Complete Decision Support
        </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {cards.map((c) => (
            <div
              key={c.title}
              className="group rounded-lg border bg-card p-6 shadow-sm transition hover:shadow-md"
            >
...
function InteractiveMockups() {
  ...
  return (
    <section id="how" className="py-20">
      ...
      <div className="container">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">
          Experience the THUNAI Workflow
        </h2>
        <p className="text-foreground/70 mb-8">
          A realistic preview of Diagnose, Chat, and Community — all working
          together.
        </p>
        ...
        <div className="overflow-hidden rounded-xl border bg-white shadow-sm">
          ...
          {tab === "diagnose" && (
            <Diagnose onConsultCommunity={() => setTab("community")} />
          )}
          {tab === "chat" && <Chat />}
      ...
      {!done ? (
        <div className="grid gap-6 md:grid-cols-3">
          <div className="md:col-span-2 rounded-lg border p-6">
            <p className="text-sm text-foreground/80 mb-4">
              Upload a photo of your crop to begin diagnosis.
            </p>
            <div className="flex items-center gap-3">
              ...
              <Button onClick={start} className="rounded-md">
                Upload
              </Button>
            </div>
            {progress > 0 && (
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border overflow-hidden bg-white">
            <img
              src="/images/placeholder-leaf-disease.svg"
              alt="Diseased leaf"
          ...
          <div className="rounded-lg border p-6 flex flex-col">
            ...
            <div className="mt-auto pt-6">
              <Button onClick={onConsultCommunity} className="rounded-md">
                Consult Community
              </Button>
            </div>
          </div>
...
function Chat() {
  const messages = useMemo(
    () => [
      {
        role: "user",
        content: "(Shows an uploaded image of a tomato plant)",
        image: "/images/placeholder-tomato.svg",
      },
      {
        role: "assistant",
        content: "Diagnosis: Tomato Mosaic Virus. This is a viral infection.",
      },
      { role: "user", content: "What are the approved organic treatments?" },
      {
        role: "assistant",
        content:
          "TNAU recommends removing and destroying infected plants to prevent spread. Neem oil can be used on surrounding plants as a preventive measure.",
      },
      {
        role: "user",
        content:
          "What is the current price for coconuts in the Pollachi market?",
      },
      {
        role: "assistant",
        content:
          "As of 11:30 AM, the price for premium coconuts in the Pollachi Regulated Market is ₹32 per piece.",
      },
    ],
    [],
  );
    ...
    <div className="p-6">
      ...
      <div className="mt-3 flex items-center gap-2">
        <input
          ...
          placeholder="Input disabled in demo"
        />
  ...
  const posts = [
    {
      id: 1,
      title:
        "AI diagnosed Leaf Blight on my turmeric. Has anyone used Trichoderma viride for this?",
      ...
      replies: [
        {
          author: "Farmer from Salem",
          text: "Yes, helped reduce spread. Applied as seed treatment and soil drench.",
        },
        {
          author: "Agri student",
          text: "Combine with good field sanitation. Remove infected leaves early.",
        },
      ],
    },
    {
      ...
      replies: [
        {
          author: "Trader",
          text: "Confirmed: prices trending up due to lower arrivals.",
        },
      ],
    },
    {
      id: 3,
      title:
        "Moderator Post: Early warning for Fall Armyworm sightings near Tiruppur.",
      author: "Moderator",
      meta: "6 hours ago, 8 replies",
      body: "Please monitor your fields. Report any sightings with photos to improve regional alerts.",
      replies: [
        {
          author: "Extension worker",
          text: "Set pheromone traps and survey weekly.",
        },
      ],
    },
  ];
      ...
      {!current ? (
        ...
        <div className="rounded-lg border bg-white p-6">
          ...
          <div className="mt-6 flex items-center gap-2">
            <input
              disabled
              placeholder="Replies are disabled in this demo"
              className="flex-1 rounded-md border bg-secondary px-3 py-2 text-sm"
            />
            <button
              disabled
              className="rounded-md bg-muted px-4 py-2 text-sm text-foreground/60"
            >
              Reply
            </button>
          </div>
    ...
    <section id="about" className="py-20 bg-secondary">
      <div className="container">
        ...
        <p className="text-foreground/70 max-w-3xl">
          Our mission is to build accessible and powerful technological tools
          that empower local farmers. We are a dedicated, multi-disciplinary
          team based in Coimbatore, combining expertise in computer science and
          a deep understanding of regional agricultural challenges.
        </p>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {team.map((m, i) => (
            ...
            >
              <div className="h-14 w-14 rounded-full bg-primary/15 grid place-items-center text-primary font-bold">
                {m.role
                  .split(" ")
                  .map((w) => w[0])
                  .join("")}
